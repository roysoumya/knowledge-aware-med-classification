...
* transformers: Contains the modified code from the ***huggingface/transformers*** Github codebase
* Text Classification: Contains of the codes used for Medical Text Classification for the Baseline Models. They were trained using the train set and evaluated using the test set provided in the data directory. It is splitted into the following three directories for comfort in understanding the usage of the codes:
